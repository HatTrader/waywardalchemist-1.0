...
import hat.waywardalchemist.items.data.WaywardAlchemistConsumableComponents;
...
public class WaywardAlchemistItems {
    ...
    public static Item PANCEA = register("pancea", Item::new, new Item.Settings().food(new FoodComponent(0,0,true), WaywardAlchemistConsumableComponents.PANCEA).useCooldown(45).maxCount(8));
    //public static Item PRIMA_MATERIA = register("prima_materia", PrimaMateriaItem::new, new Item.Settings().maxCount(1));
