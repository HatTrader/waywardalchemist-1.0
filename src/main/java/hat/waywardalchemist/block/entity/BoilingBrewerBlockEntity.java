...
import hat.waywardalchemist.screen.BoilingBrewerScreenHandler;
...
public class BoilingBrewerBlockEntity extends LockableContainerBlockEntity implements SidedInventory {
    ...
    public BoilingBrewerBlockEntity(BlockPos pos, BlockState state) {
        super(WaywardAlchemistBlockEntities.BOILING_BREWER_BE, pos, state);
        this.inventory = DefaultedList.ofSize(5, ItemStack.EMPTY);
        this.propertyDelegate = new PropertyDelegate() {
            public int get(int index) {
                int var10000;
                switch (index) {
                    case 0 -> var10000 = hat.waywardalchemist.block.entity.BoilingBrewerBlockEntity.this.brewTime;
                    case 1 -> var10000 = hat.waywardalchemist.block.entity.BoilingBrewerBlockEntity.this.fuel;
                    default -> var10000 = 0;
                }
            ...
            public void set(int index, int value) {
                switch (index) {
                    case 0 -> hat.waywardalchemist.block.entity.BoilingBrewerBlockEntity.this.brewTime = value;
                    case 1 -> hat.waywardalchemist.block.entity.BoilingBrewerBlockEntity.this.fuel = value;
                }
    ...
    protected Text getContainerName() {
        return Text.literal("Boiling Brewer");
    }

    protected ScreenHandler createScreenHandler(int syncId, PlayerInventory playerInventory) {
        return new BoilingBrewerScreenHandler(syncId, playerInventory, this, this.propertyDelegate);
    }
    ...
    public static void tick(World world, BlockPos pos, BlockState state, hat.waywardalchemist.block.entity.BoilingBrewerBlockEntity blockEntity) {
        ...
        if (!Arrays.equals(bls, blockEntity.slotsEmptyLastTick)) {
            ...
            if (!(blockState.getBlock() instanceof BoilingBrewerBlock)) {
                return;
            }

            for(int i = 0; i < BoilingBrewerBlock.BOTTLE_PROPERTIES.length; ++i) {
                blockState = (BlockState)blockState.with(BoilingBrewerBlock.BOTTLE_PROPERTIES[i], bls[i]);
            }
