...
public class BoilingBrewerScreenHandler extends ScreenHandler {
    ...
    public BoilingBrewerScreenHandler(int syncId, PlayerInventory playerInventory) {
        this(syncId, playerInventory, new SimpleInventory(5), new ArrayPropertyDelegate(2));
    }

    public BoilingBrewerScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory, PropertyDelegate propertyDelegate) {
        super(WaywardAlchemistScreenHandlers.BOILING_BREWER_SCREEN, syncId);
        ...
        this.addSlot(new BoilingBrewerScreenHandler.PotionSlot(inventory, 0, 56, 51));
        this.addSlot(new BoilingBrewerScreenHandler.PotionSlot(inventory, 1, 79, 58));
        this.addSlot(new BoilingBrewerScreenHandler.PotionSlot(inventory, 2, 102, 51));
        this.ingredientSlot = this.addSlot(new BoilingBrewerScreenHandler.IngredientSlot(brewingRecipeRegistry, inventory, 3, 79, 17));
        this.addSlot(new BoilingBrewerScreenHandler.FuelSlot(inventory, 4, 17, 17));
    ...
    public ItemStack quickMove(PlayerEntity player, int slot) {
        ...
        if (slot2 != null && slot2.hasStack()) {
            ...
            if ((slot < 0 || slot > 2) && slot != 3 && slot != 4) {
                if (BoilingBrewerScreenHandler.FuelSlot.matches(itemStack)) {
                ...
                } else if (BoilingBrewerScreenHandler.PotionSlot.matches(itemStack)) {
    ...
    static class PotionSlot extends Slot {
        ...
        public Identifier getBackgroundSprite() {
            return BoilingBrewerScreenHandler.EMPTY_POTION_SLOT_TEXTURE;
        }
    }
    ...
    private static class FuelSlot extends Slot {
        ...
        public Identifier getBackgroundSprite() {
            return BoilingBrewerScreenHandler.EMPTY_BREWING_FUEL_SLOT_TEXTURE;
        }
    }
}
